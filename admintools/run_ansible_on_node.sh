...
awx  --conf.insecure  --conf.host https://ansible.vai.org:8043 --conf.token 1BHBuHnXM0rnTZJ0akQ8GJprnAsu8o job_templates launch --wait --limit $1.hpc.vai.org 12  2>&1 | tee -a /varidata/research/software/slurmPretty/admintools/tracking/$1
#sleep 60
